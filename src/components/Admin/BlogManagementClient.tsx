    ...
    <div className="space-y-8 relative z-10">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 bg-white/[0.03] border border-white/10 p-4 sm:p-6 rounded-[2rem] backdrop-blur-2xl shadow-xl">
        <div className="flex items-center gap-4">
          <div className="p-3 bg-gradient-to-br from-fuchsia-500/20 to-pink-600/10 rounded-2xl text-fuchsia-400 border border-fuchsia-500/20 shadow-inner">
            <FileText size={24} />
          </div>
          <div>
        ...
        <button
          ...
          className={`flex items-center justify-center gap-2 px-6 py-3.5 rounded-2xl font-bold transition-all duration-300 w-full sm:w-auto shadow-lg hover:shadow-xl hover:-translate-y-0.5 active:translate-y-0 ${
            ...
            : "bg-white text-black hover:bg-fuchsia-50 shadow-white/10"
          }`}
        >
          {showForm ? (
            <>
          ...
          <div className="bg-white/[0.02] border border-white/10 rounded-[2.5rem] p-8 backdrop-blur-3xl shadow-2xl xl:sticky xl:top-8">
            ...
            <form action={handleSubmit} className="space-y-5">
              <div className="space-y-1.5 group">
                <label className="text-[10px] uppercase font-black text-gray-400 tracking-widest ml-1 group-focus-within:text-fuchsia-400 transition-colors">Article Title</label>
                <input required name="title" placeholder="e.g. Next.js 15 Server Components" className="w-full px-5 py-3.5 bg-black/40 border border-white/5 rounded-2xl text-white focus:outline-none focus:border-fuchsia-500/50 focus:bg-fuchsia-500/5 transition-all text-sm placeholder:text-gray-600" />
              </div>
              
              <div className="space-y-1.5 group">
                <label className="text-[10px] uppercase font-black text-gray-400 tracking-widest ml-1 group-focus-within:text-fuchsia-400 transition-colors">URL Slug</label>
                <input required name="slug" placeholder="e.g. nextjs-server-components" className="w-full px-5 py-3.5 bg-black/40 border border-white/5 rounded-2xl text-fuchsia-300 font-mono text-xs focus:outline-none focus:border-fuchsia-500/50 focus:bg-fuchsia-500/5 transition-all placeholder:text-gray-600" />
              </div>
              
              <div className="space-y-1.5 group">
                <label className="text-[10px] uppercase font-black text-gray-400 tracking-widest ml-1 group-focus-within:text-fuchsia-400 transition-colors">Cover Image URL</label>
                <input required type="url" name="cover" placeholder="https://..." className="w-full px-5 py-3.5 bg-black/40 border border-white/5 rounded-2xl text-white focus:outline-none focus:border-fuchsia-500/50 focus:bg-fuchsia-500/5 transition-all text-sm placeholder:text-gray-600" />
              </div>

              <div className="space-y-1.5 group">
                <label className="text-[10px] uppercase font-black text-gray-400 tracking-widest ml-1 group-focus-within:text-fuchsia-400 transition-colors">Short Excerpt</label>
                <textarea required name="excerpt" placeholder="A brief summary for the blog index..." rows={3} className="w-full px-5 py-3.5 bg-black/40 border border-white/5 rounded-2xl text-white focus:outline-none focus:border-fuchsia-500/50 focus:bg-fuchsia-500/5 transition-all text-sm placeholder:text-gray-600 resize-none custom-scrollbar" />
              </div>
              ...
              <button 
                ...
                className="w-full py-4 bg-gradient-to-r from-fuchsia-600 to-pink-600 text-white font-extrabold rounded-2xl hover:from-fuchsia-500 hover:to-pink-500 transition-all shadow-lg shadow-fuchsia-500/25 active:scale-[0.98] mt-6 flex items-center justify-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed"
              >
                {isSubmitting ? (
